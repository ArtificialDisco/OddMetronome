...
Then just cd to the root directory of the peoject and type make.
...
Of course you can bypass all that and just download the release version, at least on Windows.
